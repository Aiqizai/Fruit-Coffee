  ...
  <div class="detail">
    ...
    <div>
      ...
      <div class="imgBox">
        ...
        <div class="hot-text fl" v-if="productDetail.is_hot">hot</div>
      </div>
      <!-- 商品详情 -->
    ...
    <van-goods-action>
      <van-goods-action-icon
        ...
        :color="bagCount > 0 ? '#006699' : '#646566'"
        @click="goToShopbag"
      />
      <van-goods-action-icon
        icon="like"
        :text="isLike ? '已收藏' : '未收藏'"
        :color="isLike ? '#006699' : '#646566'"
        @click="togleLikeProducts"
      />
      <van-goods-action-button
        ...
        color="#3294c5"
      />
      <van-goods-action-button text="立即购买" color="#006699" @click="buy(true)" />
    </van-goods-action>
  </div>
</template>
